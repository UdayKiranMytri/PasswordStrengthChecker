...
def pro_info():
    ...
    <table>
        ...
        <tr>
            <td>ST#IS#6042</td>
            <td>S. Pooja</td>
            <td>pooja.suddakanti@gmail.com</td>
        </tr>
        <tr>
            <td>ST#IS#6043</td>
            <td>Y. Sushma Sri</td>
            <td>yedullasushmasri@gmail.com</td>
        </tr>
        <tr>
            <td>ST#IS#6044</td>
            <td>S. Vignesh</td>
            <td>samalavignesh@gmail.com</td>
        </tr>
        <tr>
            <td>ST#IS#6045</td>
            <td>P. Sireesha</td>
            <td>sireeshaperuri940@gmail.com</td>
        </tr>
        <tr>
            <td>ST#IS#6046</td>
            <td>M. Uday Kiran</td>
            <td>mytriudaykiran@gmail.com</td>
        </tr>
        <tr>
            <td>ST#IS#6047</td>
            <td>V. Tharun Reddy</td>
            <td>tharunreddyvennam@gmail.com</td>
        </tr>
    </table>
